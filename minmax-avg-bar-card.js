        ...
        <div class="wrap" style="--mmab-height:${d}px;">
          ...
          <div class="chart"
            ...
            <svg viewBox="0 0 ${x} ${v}" role="img" aria-label="Min max avg bar chart">
              ...
              ${B?c.map((t,e)=>e%H!=0?i:a`<text class="xText" x="${w+e*E+E/2}" y="${M+S+16}" text-anchor="middle">${formatXLabel(t.start,g,e,r,Q)}</text>`):i}
